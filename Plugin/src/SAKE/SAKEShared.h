...
namespace SAKEData
{
	...
	void LoadOverrides_Weapon(TESObjectWEAP * weapForm, json & weaponOverride, UInt8 iDebugLevel = 0);
	void LoadOverrides_Armor(TESObjectARMO * armorForm, json & armorOverride, UInt8 iDebugLevel = 0);
	void LoadOverrides_Race(TESRace * raceForm, json & raceOverride, UInt8 iDebugLevel = 0);
	void LoadOverrides_Actor(TESNPC * actorForm, json & actorOverride, UInt8 iDebugLevel = 0);
	void LoadOverrides_LeveledItem(TESLevItem * lliForm, json & llOverride, UInt8 iDebugLevel = 0);
	void LoadOverrides_LeveledActor(TESLevCharacter * llcForm, json & llOverride, UInt8 iDebugLevel = 0);
	void LoadOverrides_Ammo(TESAmmo * ammoForm, json & ammoOverride, UInt8 iDebugLevel = 0);
